...
2. In the [**Catalog**,](https://cloud.ibm.com/catalog), search for `{{site.data.keyword.messagehub}}`, then click the {{site.data.keyword.messagehub}} tile to go to the provisioning page.
